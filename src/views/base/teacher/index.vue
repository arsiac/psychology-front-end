  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" size="small" @keyup.enter.native="query">
      ...
      <el-form-item>
        ...
        <el-button v-if="$auth(authUrl, 'post')" type="danger" @click="deleteHandle()"
    ...
    <el-table
      ...
      >
        <template slot-scope="scope">
          ...
          <span v-else-if="scope.row.sex === 1">
      ...
      >
        <template slot-scope="scope">
          <span v-if="scope.row.birthday">{{ $dateString(scope.row.birthday) }}</span>
        </template>
      </el-table-column>
      <el-table-column
          prop="age"
          ...
          label="年龄">
        <template slot-scope="scope">
          <span v-if="scope.row.birthday">{{ new Date().getFullYear() - new Date(scope.row.birthday).getFullYear() }}</span>
        </template>
      </el-table-column>
      <el-table-column
          prop="departmentName"
      ...
      <el-table-column
          ...
          label="海外经历">
        <template slot-scope="scope">
          <i v-if="scope.row.oversea === 1" class="fa fa-check"></i>
          <i v-else-if="scope.row.oversea === 0" class="fa fa-close"></i>
        </template>
      </el-table-column>
      <el-table-column
          prop="relation"
...
export default {
  ...
  methods: {
    ...
    getDataList () {
      ...
      teacherApi.fuzzy(Object.assign({}, this.dataForm, {
